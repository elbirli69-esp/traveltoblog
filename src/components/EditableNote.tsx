...
export default function EditableNote({
      ...
      <li className="surface-inset px-3 py-3 text-sm">
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          ...
          <button
            ...
            onClick={cancel}
            disabled={saving}
            className="rounded-lg bg-white dark:bg-slate-900 px-3 py-1.5 text-xs font-medium text-fg-secondary ring-1 ring-slate-200 dark:ring-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/60 dark:bg-slate-950/60"
          >
            Cancelar
          </button>
        </div>
  ...
  return (
    <li className="rounded-xl bg-slate-50 dark:bg-slate-950/60 px-3 py-2 text-sm text-fg-secondary">
