...
export async function buildProjectBackup(
  ...
  const manifest: ProjectBackupManifestV1 = {
    ...
    travel: {
      ...
      journalBlogMarkdown: travel.journalBlogMarkdown ?? null,
      journalBlogGeneratedAt: iso(travel.journalBlogGeneratedAt),
      journalBlogMarkdownPrevious: travel.journalBlogMarkdownPrevious ?? null,
      ...
      htmlJournalSource: travel.htmlJournalSource ?? null,
  ...
  const result = await prisma.$transaction(async (tx) => {
    const travel = await tx.travel.create({
      data: {
        ...
        journalBlogMarkdown: manifest.travel.journalBlogMarkdown ?? null,
        journalBlogGeneratedAt: parseDate(
          manifest.travel.journalBlogGeneratedAt ?? null
        ),
        journalBlogMarkdownPrevious:
          manifest.travel.journalBlogMarkdownPrevious ?? null,
        ...
        htmlJournalSource: manifest.travel.htmlJournalSource ?? null,
